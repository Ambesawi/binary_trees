...
/**
 * inorder_successor - A function Returns the minimum value
...
/**
 * bst_delete -A function  Deletes a node from a binary search tree.
...
/**
 * bst_remove_recursive - A function that Removes a node from
